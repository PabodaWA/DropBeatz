		...
		public static List<NewUserModel> loginValidate (String username , String password ){
			...
			try {
				...
				if(rs.next()) {
					...
					NewUserModel u = new NewUserModel(id ,fullname,uname,country, contactnumber ,email ,pass);
					user.add(u);}
		...
		public static List<NewUserModel> userProfile (String Id){
			...
			try {
				...
				if(rs.next()) {
					...
					NewUserModel u = new NewUserModel(id ,fullname,username,country, contactnumber ,email ,password);
					user.add(u);
