...
public class AdminUpdateServelet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean isTrue;
		isTrue = AdminController.updatedata(Admin_id, Ad_first_name, Ad_last_name, Ad_username, Ad_contry, Ad_phone_no, Ad_email, Ad_password);
		
		if(isTrue == true) {
			
			List<AdminModel> admin = AdminController.getById(Admin_id);
